      ...
      <div className="min-h-screen bg-gray-50 p-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md max-w-3xl mx-auto">
          <div className="min-h-screen p-4">
            <div className="p-8 rounded-lg shadow-md max-w-3xl mx-auto">
              ...
              <ol className="list-decimal list-inside text-lg mb-6 text-gray-900 space-y-2">
                ...
                <li>
                  <strong>Shared universe</strong> — All stories take place in
              ...
              <ul className="list-disc list-inside text-lg mb-6 text-gray-900 space-y-2">
                <li>
                  <strong>Drafts 📝</strong> — Freshly added stories, mostly
                  from speech-to-text, with many spelling mistakes. This is
                  mainly the writer’s workspace.
                </li>
                <li>
                ...
                <li>
                  <strong>Stories 📚</strong> — The finsihed work, or what I
                  want to be so.
                </li>
                <li>
